...
func (a DecimalAddition) String() string {
	return fmt.Sprintf("%.12e", a.Number*math.Pow10(float64(a.Eponent)))
}
...
func (a BigDecimalAddition) String() string {
	return a.Number.Format(big.FmtShort, a.Number.Mul(a.Number, big.NewFloat(math.Pow10(float64(a.Eponent)))))
}
